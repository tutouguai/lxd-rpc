...
/**
 * <p>扩展类加载器。</p>
 * <p>扩展类的配置写到 {@code META-INF/extensions/lxd-rpc} 目录下，文件名为接口全名。</p>
 * <p>文件格式为：扩展名=扩展类全名。例如：{@code zk=cn.lxd.core.registry.ZkRegistry}</p>
 * <p>获取扩展类实例的代码示例如下：</p>
 * <pre>{@code
...
public class ExtensionLoader<T> {
     ...
     * 扩展类存放的目录地址
     */
    private static final String EXTENSION_PATH = "META-INF/lxd-rpc/";
